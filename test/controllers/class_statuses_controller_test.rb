...
class ClassStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_status" do
    assert_difference('ClassStatus.count') do
      post class_statuses_url, params: { class_status: { class_list_id: @class_status.class_list_id, score: @class_status.score, status: @class_status.status, student_id: @class_status.student_id } }
    end
  ...
  test "should update class_status" do
    patch class_status_url(@class_status), params: { class_status: { class_list_id: @class_status.class_list_id, score: @class_status.score, status: @class_status.status, student_id: @class_status.student_id } }
