...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { department_id: @professor.department_id, pro_name: @professor.pro_name } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { department_id: @professor.department_id, pro_name: @professor.pro_name } }
